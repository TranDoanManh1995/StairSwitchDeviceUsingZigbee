...
#include "stdbool.h"
	...
	/*------------------------------- Declare macros, variables, enum & structure types, function pointer, function prototypes -------------------------------*/
...
#define BUTTON_CHECK_RELEASE_MS				500			// 500 milliseconds from the time the button is released
